...
CORS_ALLOWED_ORIGINS = env_list(
    ...
    "https://capstone-tan-ten.vercel.app,http://localhost:8080,http://127.0.0.1:8080,http://localhost:3000,http://127.0.0.1:3000"
)

# Ensure production frontend is always allowed
if "https://capstone-tan-ten.vercel.app" not in CORS_ALLOWED_ORIGINS:
    CORS_ALLOWED_ORIGINS.append("https://capstone-tan-ten.vercel.app")

# Allow local development
for local_origin in ["http://localhost:8080", "http://127.0.0.1:8080", "http://localhost:3000", "http://127.0.0.1:3000"]:
    if local_origin not in CORS_ALLOWED_ORIGINS:
        CORS_ALLOWED_ORIGINS.append(local_origin)

# Additional CORS settings for proper cross-origin requests
